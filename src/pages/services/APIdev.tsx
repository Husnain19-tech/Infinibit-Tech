...
const APIdev = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 relative"><div className="container mx-auto px-6"><InfoCard title="Why Choose API Development" features={serviceData.whyChoose} imageUrl="/images/services/api-development-why.webp" imagePosition="left" /></div></section>
      <section className="py-20 relative"><div className="container mx-auto px-6"><TechStackCard techStack={serviceData.techStack} imageUrl="/images/services/api-development-tech.webp" imagePosition="right" /></div></section>
